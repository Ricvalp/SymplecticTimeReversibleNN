...
train_dataset, val_dataset = pp.train_dataset(x, y, 100, 900, 100) #val_len, train_batch, val_batch
...
plt.plot(history1R.history["loss"], label="Training loss $\mathbf{H}_{R, 20}^{H}$")
plt.plot(history1R.history["val_loss"], label="Validation loss $\mathbf{H}_{R, 20}^{H}$")

plt.plot(history1N.history["loss"], label="Training loss $\mathbf{H}_{20}^{H}$")
plt.plot(history1N.history["val_loss"], label="Validation loss $\mathbf{H}_{20}^{H}$")

plt.plot(history1N2.history["loss"], label="Training loss $\mathbf{H}_{40}^{H}$")
plt.plot(history1N2.history["val_loss"], label="Validation loss $\mathbf{H}_{40}^{H}$")
...
plt.plot(history2R.history["loss"], label="Training loss $\mathbf{H}_{R, 50}^{H}$")
plt.plot(history2R.history["val_loss"], label="Validation loss $\mathbf{H}_{R, 50}^{H}$")

plt.plot(history2N.history["loss"], label="Training loss $\mathbf{H}_{50}^{H}")
plt.plot(history2N.history["val_loss"], label="Validation loss $\mathbf{H}_{50}^{H}$")
