...
#CHECKPOINT 1,2,3
checkpoint_path_1R = "checkpoints_HM_HH_1R/cp.ckpt"
checkpoint_dir_1R = os.path.dirname(checkpoint_path_1R)

checkpoint_path_2R = "checkpoints_HM_HH_2R/cp.ckpt"
checkpoint_dir_2R = os.path.dirname(checkpoint_path_2R)

checkpoint_path_1N = "checkpoints_HM_HH_1N/cp.ckpt"
checkpoint_dir_1N = os.path.dirname(checkpoint_path_1N)

checkpoint_path_2N = "checkpoints_HM_HH_2N/cp.ckpt"
checkpoint_dir_2N = os.path.dirname(checkpoint_path_2N)

checkpoint_path_1N2 = "checkpoints_HM_HH_1N2/cp.ckpt"
